...
<html lang="en">
    <head>
        ...
        <title>Admin Manage Units per Classes</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage Units per Classes</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Subjects</li>
            							<li class="active">Manage Units per Classes</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>View Units per Classes Info</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
