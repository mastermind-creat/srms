...
<html lang="en">
    <head>
        ...
        <title>SMS Admin Assign Subject/Units to Classes< </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Assign Subject/Units to Classes</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Subjects</li>
                                        <li class="active">Assign Subjects/Units to Classes</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Assign Subjects/Units to Classes</h5>
                                                </div>
                                            </div>
