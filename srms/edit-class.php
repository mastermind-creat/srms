...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- DICT S22, DEET J23, DHRM, CICT etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="section" value="<?php echo htmlentities($result->Section);?>" class="form-control" maxlength="50" required="required" id="success">
                                                            <span class="help-block">Eg- COMPUTING, ENGINEERING, BUSINESS etc</span>
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
  <div class="form-group has-success">
