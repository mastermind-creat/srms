...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Admission</label>
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" value="<?php echo htmlentities($result->RollId)?>" maxlength="12" required="required" autocomplete="off">
</div>
</div>
